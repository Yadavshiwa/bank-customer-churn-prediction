...
Place the Churn_Modelling.csv file in the same directory as the Jupyter notebook.
Open the bank-customer-churn-prediction.ipynb notebook.
Execute the cells to perform the analysis and see the results.
Requirements
Python 3.x
Jupyter Notebook
...
pip install pandas numpy scikit-learn matplotlib seaborn# Bank-Customer-Churn-Analysis
